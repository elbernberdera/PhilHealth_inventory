...
urlpatterns = [
    ...
    path('api/ppe-assets/<int:asset_id>/update-inline/', views.ppe_asset_update_inline, name='ppe_asset_update_inline'),
    path('api/ppe-assets/bulk-delete/', views.ppe_asset_bulk_delete, name='ppe_asset_bulk_delete'),
    ...
    path('api/supplies/bulk-delete/', views.supply_bulk_delete, name='supply_bulk_delete'),
